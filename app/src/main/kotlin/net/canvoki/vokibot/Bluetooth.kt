...
enum class DisconnectableRole(
    ...
    A2DP(BluetoothProfile.A2DP, R.string.bluetooth_profile_a2dp),
    A2DP_SINK(BLUETOOTH_PROFILE_A2DP_SINK, R.string.bluetooth_profile_a2dp_sink),
    AVRCP_CONTROLLER(BLUETOOTH_PROFILE_AVRCP_CONTROLLER, R.string.bluetooth_profile_avrcp_controller),
    AVRCP_TARGET(BLUETOOTH_PROFILE_AVRCP_TARGET, R.string.bluetooth_profile_avrcp_target),
    HEADSET(BluetoothProfile.HEADSET, R.string.bluetooth_profile_headset),
    HEADSET_CLIENT(BLUETOOTH_PROFILE_HEADSET_CLIENT, R.string.bluetooth_profile_headset_client),
    HID_DEVICE(BLUETOOTH_PROFILE_HID_DEVICE, R.string.bluetooth_profile_hid_device),
    HID_HOST(BLUETOOTH_PROFILE_HID_HOST, R.string.bluetooth_profile_hid_host),
    MAP(BLUETOOTH_PROFILE_MAP, R.string.bluetooth_profile_map),
    MAP_CLIENT(BLUETOOTH_PROFILE_MAP_CLIENT, R.string.bluetooth_profile_map_client),
    PAN(BLUETOOTH_PROFILE_PAN, R.string.bluetooth_profile_pan),
    PBAP(BLUETOOTH_PROFILE_PBAP, R.string.bluetooth_profile_pbap),
    PBAP_CLIENT(BLUETOOTH_PROFILE_PBAP_CLIENT, R.string.bluetooth_profile_pbap_client),
}
