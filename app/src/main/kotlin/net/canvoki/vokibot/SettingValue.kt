...
val SETTING_VALUES: List<SettingValue> =
    listOf(
        ...
        SettingValue(
            ...
            dev = "1 for enabled, 0 for disabled",
        ),
        SettingValue(
        ...
        SettingValue(
            ...
            dev = "Integer in milliseconds (e.g. 60000 for 1 minute)",
        ),
        SettingValue(
        ...
        SettingValue(
            ...
            dev = "0=manual, 1=accelerometer controls rotation",
        ),
        SettingValue(
        ...
        SettingValue(
            ...
            dev = "0 for disabled, 1 for enabled",
        ),
        SettingValue(
        ...
        SettingValue(
            ...
            dev = "Bitmask: voice_call=1, system=2, ring=4, music=8, alarm=16, notification=32, bt_sco=64",
        ),
        SettingValue(
        ...
        SettingValue(
            ...
            dev = "Bitmask: call=1, call_cdma=2, notification=4, chat=8, calendar=16, hangup=32",
        ),
        SettingValue(
            ...
            dev = "0=normal, 1=vibrate, 2=silent",
        ),
        SettingValue(
        ...
        SettingValue(
            ...
            dev = "Space-separated package names",
        ),
        // Text
        SettingValue(
        ...
        SettingValue(
            ...
            dev = "Format string (e.g. mm/dd/yyyy, dd/mm/yyyy, yyyy/mm/dd)",
        ),
        SettingValue(
        ...
        SettingValue(
            ...
            dev = "Integer bitmask for preferred networks",
        ),
        SettingValue(
        ...
        SettingValue(
            ...
            dev = "Comma-separated list (e.g. bluetooth,cell,nfc,wifi)",
        ),
        SettingValue(
            ...
            dev = "0=default, 1=never while plugged, 2=never",
        ),
        SettingValue(
        ...
        SettingValue(
            ...
            dev = "Integer in seconds (e.g. 120, 300, 600)",
        ),
        SettingValue(
            ...
            dev = "0=end call, 1=go to caller log",
        ),
        // Accessibility
        SettingValue(
        ...
        SettingValue(
            ...
            dev = "Colon-separated component names",
        ),
        SettingValue(
        ...
        SettingValue(
            ...
            dev = "Float (0.0=off, 0.5, 1.0, 1.5, 2.0, 5.0, 10.0)",
        ),
        SettingValue(
        ...
        SettingValue(
            ...
            dev = "Bitmask: usb=1, ac=2, wireless=4",
        ),
        SettingValue(
        ...
        SettingValue(
            ...
            dev = "0=not provisioned, 1=provisioned",
        ),
        SettingValue(
